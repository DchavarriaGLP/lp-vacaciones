...
const NAV_ITEMS: NavItem[] = [
  { href: '/dashboard', label: 'Dashboard', icon: <HomeIcon />, roles: ['employee', 'manager', 'admin'] },
  { href: '/vacaciones', label: 'Mis Vacaciones', icon: <CalendarIcon />, roles: ['employee', 'manager', 'admin'] },
  { href: '/aprobaciones', label: 'Aprobaciones', icon: <CheckCircleIcon />, roles: ['manager', 'admin'] },
  { href: '/equipo', label: 'Mi Equipo', icon: <UserGroupIcon />, roles: ['manager', 'admin'] },
...
export function AppSidebar({ role, username }: Props) {
